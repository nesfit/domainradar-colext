...
COPY classifiers/pyproject.toml classifiers/poetry.lock  classifiers/*.md ./classifiers/
...
RUN mkdir common && touch common/__init__.py && \ 
    ...
    mkdir classifiers/classifiers && touch classifiers/classifiers/__init__.py
