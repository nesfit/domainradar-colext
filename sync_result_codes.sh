...
JAVA_FILE="./collectors-java/common/src/main/java/cz/vut/fit/domainradar/models/ResultCodes.java"
# Output filename for the Python file
PYTHON_FILE="./collectors-python/src/common/result_codes.py"
