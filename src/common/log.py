"""
log.py: A simple logging module that provides a custom logger with additional methods
for key-based logging.
"""
...
class _CustomLoggerT(logging.Logger):
    ...
    This class adds additional methods for trace logging and key-based logging. It also includes
    attributes for stderr and Kafka handlers, which can be used to direct log output to stderr or
    a Kafka topic, respectively.
    """
    ...
    def trace(self, message, *args, **kwargs):
        ...
        This method is similar to the standard logging methods (e.g., debug, info, etc.),
        but it logs at the trace level, which is lower than the debug level.
    ...
    def k_trace(self, message: str, key: str | None = None, *args, **kwargs):
        ...
        This method is similar to the trace method, but it includes a key in the log output.
        The key can be used to group related log messages.

        Args:
            message (str): The message to be logged.
            key (str | None): The key to be included in the log output. If None, a default key
                              is used.
            *args: Variable length argument list.
            **kwargs: Arbitrary keyword arguments.
        """
    ...
    def k_debug(self, message: str, key: str | None = None, *args, **kwargs):
        ...
        This method is similar to the standard debug method, but it includes a key in the log
        output. The key can be used to group related log messages.
    ...
    def k_info(self, message: str, key: str | None = None, *args, **kwargs):
        ...
        Args:
            message (str): The message to be logged.
            key (str | None): The key to be included in the log output. If None,
    ...
    def k_warning(
        self, message: str, key: str | None = None, *args, e: BaseException = None, **kwargs
    ):
        """
        Logs a warning level message with a key.

        This method is similar to the standard warning method, but it includes a key in the log
        output. The key can be used to group related log messages.
        ...
        Args:
            ...
            key (str | None): The key to be included in the log output. If None, a default key
                              is used.
            e (BaseException, optional): The exception to be logged. If provided, the traceback is
    ...
    def k_unhandled_error(self, e: BaseException, key: str | None = None, **kwargs):
        ...
        This method is used to log unhandled exceptions. It includes a key in the log output and
        logs the traceback of the exception.
...
class ExtraFormatter(logging.Formatter):
    ...
    def __init__(self, fmt=None, datefmt=None, style="%", validate=True, *, defaults=None):
        super().__init__(
            fmt="[{asctime}] [{levelname}] [{name}#{thread}-{threadName}] {{{event_key}}} {message}",  # noqa: E501
            style="{",
            datefmt="",
        )
