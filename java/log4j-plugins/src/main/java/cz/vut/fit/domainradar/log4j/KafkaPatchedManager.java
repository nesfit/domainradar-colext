...
public class KafkaPatchedManager extends AbstractManager {
    ...
    private static final KafkaPatchedManagerFactory factory = new KafkaPatchedManagerFactory();

    /*
     * The Constructor should have been declared private as all Managers are create
     * by the internal factory;
     */
    public KafkaPatchedManager(
    ...
    public void send(final byte[] msg, final LogEvent event)
    ...
    @Deprecated
    public static KafkaPatchedManager getManager(
            final LoggerContext loggerContext,
            final String name,
            final String topic,
            final boolean syncSend,
    ...
    static KafkaPatchedManager getManager(
            final LoggerContext loggerContext,
            final String name,
            final String topic,
            final boolean syncSend,
    ...
    private static class KafkaPatchedManagerFactory implements ManagerFactory<KafkaPatchedManager, FactoryData> {
        @Override
        public KafkaPatchedManager createManager(final String name, final FactoryData data) {
            return new KafkaPatchedManager(
